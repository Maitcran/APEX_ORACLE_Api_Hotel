...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(93901120888931864388)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(93901121205296864389)
,p_plugin_id=>wwv_flow_imp.id(93901120888931864388)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(93901121498139864389)
,p_plugin_attribute_id=>wwv_flow_imp.id(93901121205296864389)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'IMAGE'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(93901121868614864389)
,p_plugin_attribute_id=>wwv_flow_imp.id(93901121205296864389)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(93901122270439864390)
,p_plugin_attribute_id=>wwv_flow_imp.id(93901121205296864389)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(93901122663095864390)
,p_plugin_id=>wwv_flow_imp.id(93901120888931864388)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(93901121205296864389)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(93901122947201864390)
,p_plugin_id=>wwv_flow_imp.id(93901120888931864388)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(93901122663095864390)
,p_depending_on_has_to_exist=>true
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(93901123320943864390)
,p_plugin_id=>wwv_flow_imp.id(93901120888931864388)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(93901123565021864390)
,p_plugin_id=>wwv_flow_imp.id(93901120888931864388)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(93901123912167864390)
,p_plugin_id=>wwv_flow_imp.id(93901120888931864388)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(93901124202009864390)
,p_plugin_attribute_id=>wwv_flow_imp.id(93901123912167864390)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(93901124597041864390)
,p_plugin_attribute_id=>wwv_flow_imp.id(93901123912167864390)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(93901124962552864391)
,p_plugin_attribute_id=>wwv_flow_imp.id(93901123912167864390)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(93901125373283864391)
,p_plugin_id=>wwv_flow_imp.id(93901120888931864388)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(93901125658574864391)
,p_plugin_attribute_id=>wwv_flow_imp.id(93901125373283864391)
,p_display_sequence=>10
,p_display_value=>'Extra Extra Small'
,p_return_value=>'t-Avatar--xs'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(93901126117607864391)
,p_plugin_attribute_id=>wwv_flow_imp.id(93901125373283864391)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(93901126522374864391)
,p_plugin_attribute_id=>wwv_flow_imp.id(93901125373283864391)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(93901126836883864391)
,p_plugin_attribute_id=>wwv_flow_imp.id(93901125373283864391)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(93901127274908864391)
,p_plugin_attribute_id=>wwv_flow_imp.id(93901125373283864391)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(93901127651151864392)
,p_plugin_attribute_id=>wwv_flow_imp.id(93901125373283864391)
,p_display_sequence=>60
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(93901128085702864392)
,p_plugin_attribute_id=>wwv_flow_imp.id(93901125373283864391)
,p_display_sequence=>70
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(93901128474425864392)
,p_plugin_id=>wwv_flow_imp.id(93901120888931864388)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(95701171707297978140)
,p_plugin_id=>wwv_flow_imp.id(93901120888931864388)
,p_name=>'Link'
,p_static_id=>'LINK'
,p_display_sequence=>10
