...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(93901138417204864398)
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(95701023888389896114)
,p_plugin_id=>wwv_flow_imp.id(93901138417204864398)
,p_title=>'Avatar'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(93901138924146864398)
,p_plugin_id=>wwv_flow_imp.id(93901138417204864398)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(93901139207087864398)
,p_plugin_id=>wwv_flow_imp.id(93901138417204864398)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(93901139474416864398)
,p_plugin_id=>wwv_flow_imp.id(93901138417204864398)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(93901139765140864398)
,p_plugin_id=>wwv_flow_imp.id(93901138417204864398)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(93901140121738864399)
,p_plugin_id=>wwv_flow_imp.id(93901138417204864398)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(93901144657970864400)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(95701023888389896114)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(93901140352184864399)
,p_plugin_attribute_id=>wwv_flow_imp.id(93901140121738864399)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(93901140791036864399)
,p_plugin_attribute_id=>wwv_flow_imp.id(93901140121738864399)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(93901141141931864399)
,p_plugin_attribute_id=>wwv_flow_imp.id(93901140121738864399)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(93901141577762864399)
,p_plugin_id=>wwv_flow_imp.id(93901138417204864398)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(93901140121738864399)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(93901141894892864399)
,p_plugin_id=>wwv_flow_imp.id(93901138417204864398)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>true
,p_depending_on_attribute_id=>wwv_flow_imp.id(93901141577762864399)
,p_depending_on_has_to_exist=>true
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(93901142209561864399)
,p_plugin_id=>wwv_flow_imp.id(93901138417204864398)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(93901142472588864400)
,p_plugin_id=>wwv_flow_imp.id(93901138417204864398)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(93901142817942864400)
,p_plugin_id=>wwv_flow_imp.id(93901138417204864398)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(93901143064992864400)
,p_plugin_attribute_id=>wwv_flow_imp.id(93901142817942864400)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(93901143522759864400)
,p_plugin_attribute_id=>wwv_flow_imp.id(93901142817942864400)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(93901143873176864400)
,p_plugin_attribute_id=>wwv_flow_imp.id(93901142817942864400)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(93901144319835864400)
,p_plugin_attribute_id=>wwv_flow_imp.id(93901142817942864400)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(93901144657970864400)
,p_plugin_id=>wwv_flow_imp.id(93901138417204864398)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(93901144928747864401)
,p_plugin_id=>wwv_flow_imp.id(93901138417204864398)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(93901145260828864401)
,p_plugin_attribute_id=>wwv_flow_imp.id(93901144928747864401)
,p_display_sequence=>10
,p_display_value=>'Basic'
,p_return_value=>'t-Comments--basic'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(93901145675904864401)
,p_plugin_attribute_id=>wwv_flow_imp.id(93901144928747864401)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(93901146054002864401)
,p_plugin_id=>wwv_flow_imp.id(93901138417204864398)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_act_template(
 p_id=>wwv_flow_imp.id(95701156555822997617)
,p_plugin_id=>wwv_flow_imp.id(93901138417204864398)
,p_name=>'Link'
,p_type=>'BUTTON'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(95701155964317990160)
,p_plugin_id=>wwv_flow_imp.id(93901138417204864398)
,p_name=>'Actions'
,p_static_id=>'ACTIONS'
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(95701211587987972039)
,p_plugin_id=>wwv_flow_imp.id(93901138417204864398)
,p_name=>'Avatar Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(95701363805700842810)
,p_plugin_id=>wwv_flow_imp.id(93901138417204864398)
