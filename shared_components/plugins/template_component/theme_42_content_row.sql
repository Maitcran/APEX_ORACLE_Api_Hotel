...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(93901148335614864403)
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(95828386215242936098)
,p_plugin_id=>wwv_flow_imp.id(93901148335614864403)
,p_title=>'Avatar'
,p_display_sequence=>10
);
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(95828385660230936097)
,p_plugin_id=>wwv_flow_imp.id(93901148335614864403)
,p_title=>'Badge'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(93901149054858864403)
,p_plugin_id=>wwv_flow_imp.id(93901148335614864403)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(93901149370130864403)
,p_plugin_id=>wwv_flow_imp.id(93901148335614864403)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(93901149629948864403)
,p_plugin_id=>wwv_flow_imp.id(93901148335614864403)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(93901149942401864404)
,p_plugin_id=>wwv_flow_imp.id(93901148335614864403)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(93901150321891864404)
,p_plugin_id=>wwv_flow_imp.id(93901148335614864403)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(93901150591598864404)
,p_plugin_id=>wwv_flow_imp.id(93901148335614864403)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(93901150891079864404)
,p_plugin_id=>wwv_flow_imp.id(93901148335614864403)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(93901150321891864404)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(95828386215242936098)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(93901151207184864404)
,p_plugin_attribute_id=>wwv_flow_imp.id(93901150891079864404)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(93901151562457864404)
,p_plugin_attribute_id=>wwv_flow_imp.id(93901150891079864404)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(93901151953742864405)
,p_plugin_attribute_id=>wwv_flow_imp.id(93901150891079864404)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(93901152371580864405)
,p_plugin_id=>wwv_flow_imp.id(93901148335614864403)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(93901150891079864404)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(93901152717210864405)
,p_plugin_id=>wwv_flow_imp.id(93901148335614864403)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>true
,p_depending_on_attribute_id=>wwv_flow_imp.id(93901152371580864405)
,p_depending_on_has_to_exist=>true
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(93901152937876864405)
,p_plugin_id=>wwv_flow_imp.id(93901148335614864403)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(93901153263457864405)
,p_plugin_id=>wwv_flow_imp.id(93901148335614864403)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(93901153554322864405)
,p_plugin_id=>wwv_flow_imp.id(93901148335614864403)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(93901153833339864405)
,p_plugin_attribute_id=>wwv_flow_imp.id(93901153554322864405)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(93901154224835864405)
,p_plugin_attribute_id=>wwv_flow_imp.id(93901153554322864405)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(93901154641806864406)
,p_plugin_attribute_id=>wwv_flow_imp.id(93901153554322864405)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(93901155101159864406)
,p_plugin_attribute_id=>wwv_flow_imp.id(93901153554322864405)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(93901155487683864406)
,p_plugin_id=>wwv_flow_imp.id(93901148335614864403)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>true
,p_depending_on_attribute_id=>wwv_flow_imp.id(93901150591598864404)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_attribute_group_id=>wwv_flow_imp.id(95828385660230936097)
,p_help_text=>'Enter a value for the badge label or select a source column from the quick pick options.'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(93901155736780864406)
,p_plugin_id=>wwv_flow_imp.id(93901148335614864403)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(93901156038541864406)
,p_plugin_id=>wwv_flow_imp.id(93901148335614864403)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(93901156408339864406)
,p_plugin_id=>wwv_flow_imp.id(93901148335614864403)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(93901156695012864406)
,p_plugin_id=>wwv_flow_imp.id(93901148335614864403)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(93901156999210864407)
,p_plugin_id=>wwv_flow_imp.id(93901148335614864403)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(93901157239443864407)
,p_plugin_attribute_id=>wwv_flow_imp.id(93901156999210864407)
,p_display_sequence=>10
,p_display_value=>'Subtle'
,p_return_value=>'t-Badge--subtle'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(93901157639296864407)
,p_plugin_attribute_id=>wwv_flow_imp.id(93901156999210864407)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(93901158053089864407)
,p_plugin_id=>wwv_flow_imp.id(93901148335614864403)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(93901158332920864407)
,p_plugin_attribute_id=>wwv_flow_imp.id(93901158053089864407)
,p_display_sequence=>10
,p_display_value=>'Rounded'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(93901158741310864407)
,p_plugin_attribute_id=>wwv_flow_imp.id(93901158053089864407)
,p_display_sequence=>20
,p_display_value=>'Circular'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(93901159209343864407)
,p_plugin_attribute_id=>wwv_flow_imp.id(93901158053089864407)
,p_display_sequence=>30
,p_display_value=>'Square'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(93901159599331864408)
,p_plugin_id=>wwv_flow_imp.id(93901148335614864403)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(93901159873203864408)
,p_plugin_attribute_id=>wwv_flow_imp.id(93901159599331864408)
,p_display_sequence=>10
,p_display_value=>'Extra Extra Small'
,p_return_value=>'t-Avatar--xxs'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(93901160285639864408)
,p_plugin_attribute_id=>wwv_flow_imp.id(93901159599331864408)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(93901160697319864408)
,p_plugin_attribute_id=>wwv_flow_imp.id(93901159599331864408)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(93901161039360864408)
,p_plugin_attribute_id=>wwv_flow_imp.id(93901159599331864408)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(93901161458852864408)
,p_plugin_attribute_id=>wwv_flow_imp.id(93901159599331864408)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(93901161852126864408)
,p_plugin_attribute_id=>wwv_flow_imp.id(93901159599331864408)
,p_display_sequence=>60
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(93901162319845864408)
,p_plugin_attribute_id=>wwv_flow_imp.id(93901159599331864408)
,p_display_sequence=>70
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(93901162685470864409)
,p_plugin_id=>wwv_flow_imp.id(93901148335614864403)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(93901162981105864409)
,p_plugin_attribute_id=>wwv_flow_imp.id(93901162685470864409)
,p_display_sequence=>10
,p_display_value=>'Small'
,p_return_value=>'t-Badge--sm'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(93901163362675864409)
,p_plugin_attribute_id=>wwv_flow_imp.id(93901162685470864409)
,p_display_sequence=>20
,p_display_value=>'Medium'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(93901163760400864409)
,p_plugin_attribute_id=>wwv_flow_imp.id(93901162685470864409)
,p_display_sequence=>30
,p_display_value=>'Large'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(93901164210402864409)
,p_plugin_id=>wwv_flow_imp.id(93901148335614864403)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(93901164479417864409)
,p_plugin_attribute_id=>wwv_flow_imp.id(93901164210402864409)
,p_display_sequence=>10
,p_display_value=>'Small'
,p_return_value=>'t-ContentRow-badge--sm'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(93901164893226864409)
,p_plugin_attribute_id=>wwv_flow_imp.id(93901164210402864409)
,p_display_sequence=>20
,p_display_value=>'Medium'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(93901165265421864410)
,p_plugin_attribute_id=>wwv_flow_imp.id(93901164210402864409)
,p_display_sequence=>30
,p_display_value=>'Large'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(93901165700718864410)
,p_plugin_attribute_id=>wwv_flow_imp.id(93901164210402864409)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(93901166090486864410)
,p_plugin_id=>wwv_flow_imp.id(93901148335614864403)
...
wwv_flow_imp_shared.create_plugin_act_template(
 p_id=>wwv_flow_imp.id(95709600105458757712)
,p_plugin_id=>wwv_flow_imp.id(93901148335614864403)
,p_name=>'Button'
,p_type=>'BUTTON'
...
wwv_flow_imp_shared.create_plugin_act_template(
 p_id=>wwv_flow_imp.id(95709601364978761860)
,p_plugin_id=>wwv_flow_imp.id(93901148335614864403)
,p_name=>'Menu'
,p_type=>'MENU'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(95696006476784350979)
,p_plugin_id=>wwv_flow_imp.id(93901148335614864403)
,p_name=>'Title Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(95696685777514434083)
,p_plugin_id=>wwv_flow_imp.id(93901148335614864403)
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(95709598170391712726)
,p_plugin_id=>wwv_flow_imp.id(93901148335614864403)
,p_name=>'Avatar Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(95709599503781726583)
,p_plugin_id=>wwv_flow_imp.id(93901148335614864403)
