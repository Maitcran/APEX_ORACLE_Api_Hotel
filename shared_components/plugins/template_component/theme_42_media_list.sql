...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(93901170733986864413)
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(95701188635729748061)
,p_plugin_id=>wwv_flow_imp.id(93901170733986864413)
,p_title=>'Badge'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(95701189190741748062)
,p_plugin_id=>wwv_flow_imp.id(93901170733986864413)
,p_title=>'Avatar'
,p_display_sequence=>10
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(93901171454547864413)
,p_plugin_id=>wwv_flow_imp.id(93901170733986864413)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(93901171818572864413)
,p_plugin_id=>wwv_flow_imp.id(93901170733986864413)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(93901172117298864414)
,p_plugin_id=>wwv_flow_imp.id(93901170733986864413)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(93901172394190864414)
,p_plugin_id=>wwv_flow_imp.id(93901170733986864413)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(93901172694428864414)
,p_plugin_id=>wwv_flow_imp.id(93901170733986864413)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(93901172117298864414)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(95701189190741748062)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(93901172942970864414)
,p_plugin_attribute_id=>wwv_flow_imp.id(93901172694428864414)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(93901173417010864415)
,p_plugin_attribute_id=>wwv_flow_imp.id(93901172694428864414)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(93901173783879864415)
,p_plugin_attribute_id=>wwv_flow_imp.id(93901172694428864414)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(93901174178403864415)
,p_plugin_id=>wwv_flow_imp.id(93901170733986864413)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(93901172694428864414)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(93901174522233864415)
,p_plugin_id=>wwv_flow_imp.id(93901170733986864413)
,p_attribute_scope=>'COMPONENT'
...
,p_depending_on_attribute_id=>wwv_flow_imp.id(93901174178403864415)
,p_depending_on_has_to_exist=>true
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(93901174792848864415)
,p_plugin_id=>wwv_flow_imp.id(93901170733986864413)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(93901175112058864415)
,p_plugin_id=>wwv_flow_imp.id(93901170733986864413)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(93901175382079864415)
,p_plugin_id=>wwv_flow_imp.id(93901170733986864413)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(93901175651573864415)
,p_plugin_attribute_id=>wwv_flow_imp.id(93901175382079864415)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(93901176075737864416)
,p_plugin_attribute_id=>wwv_flow_imp.id(93901175382079864415)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(93901176493967864416)
,p_plugin_attribute_id=>wwv_flow_imp.id(93901175382079864415)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(93901176829105864416)
,p_plugin_attribute_id=>wwv_flow_imp.id(93901175382079864415)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(93901177271845864416)
,p_plugin_id=>wwv_flow_imp.id(93901170733986864413)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>true
,p_depending_on_attribute_id=>wwv_flow_imp.id(93901172394190864414)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_attribute_group_id=>wwv_flow_imp.id(95701188635729748061)
,p_help_text=>'Enter a value for the badge label or select a source column from the quick pick options.'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(93901177616358864416)
,p_plugin_id=>wwv_flow_imp.id(93901170733986864413)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(93901177918776864416)
,p_plugin_id=>wwv_flow_imp.id(93901170733986864413)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(93901178175380864416)
,p_plugin_id=>wwv_flow_imp.id(93901170733986864413)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(93901178442713864417)
,p_plugin_id=>wwv_flow_imp.id(93901170733986864413)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(93901178805251864417)
,p_plugin_id=>wwv_flow_imp.id(93901170733986864413)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(93901179044798864417)
,p_plugin_attribute_id=>wwv_flow_imp.id(93901178805251864417)
,p_display_sequence=>10
,p_display_value=>'Subtle'
,p_return_value=>'t-Badge--subtle'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(93901179516548864417)
,p_plugin_attribute_id=>wwv_flow_imp.id(93901178805251864417)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(93901179876102864417)
,p_plugin_id=>wwv_flow_imp.id(93901170733986864413)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(93901180134334864417)
,p_plugin_attribute_id=>wwv_flow_imp.id(93901179876102864417)
,p_display_sequence=>10
,p_display_value=>'Rounded'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(93901180564945864417)
,p_plugin_attribute_id=>wwv_flow_imp.id(93901179876102864417)
,p_display_sequence=>20
,p_display_value=>'Circular'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(93901180998111864418)
,p_plugin_attribute_id=>wwv_flow_imp.id(93901179876102864417)
,p_display_sequence=>30
,p_display_value=>'Square'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(93901181365729864418)
,p_plugin_id=>wwv_flow_imp.id(93901170733986864413)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(93901181681345864418)
,p_plugin_attribute_id=>wwv_flow_imp.id(93901181365729864418)
,p_display_sequence=>10
,p_display_value=>'2 Column Grid'
,p_return_value=>'t-MediaList--cols t-MediaList--2cols'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(93901182041868864418)
,p_plugin_attribute_id=>wwv_flow_imp.id(93901181365729864418)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(93901182430526864418)
,p_plugin_attribute_id=>wwv_flow_imp.id(93901181365729864418)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(93901182834344864418)
,p_plugin_attribute_id=>wwv_flow_imp.id(93901181365729864418)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(93901183279850864418)
,p_plugin_attribute_id=>wwv_flow_imp.id(93901181365729864418)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(93901183656975864419)
,p_plugin_id=>wwv_flow_imp.id(93901170733986864413)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(93901183932067864419)
,p_plugin_attribute_id=>wwv_flow_imp.id(93901183656975864419)
,p_display_sequence=>10
,p_display_value=>'Large'
,p_return_value=>'t-MediaList--large force-fa-lg'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(93901184354070864419)
,p_plugin_id=>wwv_flow_imp.id(93901170733986864413)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(95701392242898894690)
,p_plugin_id=>wwv_flow_imp.id(93901170733986864413)
,p_name=>'Link'
,p_static_id=>'LINK'
,p_display_sequence=>10
