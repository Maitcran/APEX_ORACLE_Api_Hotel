...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(93900943170201864313)
,p_theme_id=>42
,p_name=>'Drawer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(93900943479661864314)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(93900943759005864314)
,p_page_template_id=>wwv_flow_imp.id(93900943170201864313)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(93900944111991864314)
,p_page_template_id=>wwv_flow_imp.id(93900943170201864313)
