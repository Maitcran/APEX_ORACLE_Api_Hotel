...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(93900953808965864318)
,p_theme_id=>42
,p_name=>'Login'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(93900954050182864319)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(93900954408307864319)
,p_page_template_id=>wwv_flow_imp.id(93900953808965864318)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(93900954634686864319)
,p_page_template_id=>wwv_flow_imp.id(93900953808965864318)
,p_name=>'Body Header'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(93900954983565864319)
,p_page_template_id=>wwv_flow_imp.id(93900953808965864318)
,p_name=>'Body Footer'
