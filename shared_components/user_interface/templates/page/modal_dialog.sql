...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(93900963735038864323)
,p_theme_id=>42
,p_name=>'Modal Dialog'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(93900964114785864323)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(93900964382009864323)
,p_page_template_id=>wwv_flow_imp.id(93900963735038864323)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(93900964639743864323)
,p_page_template_id=>wwv_flow_imp.id(93900963735038864323)
