...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(93900965249063864324)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(93900965568805864324)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(93900965842375864324)
,p_page_template_id=>wwv_flow_imp.id(93900965249063864324)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(93900966175040864324)
,p_page_template_id=>wwv_flow_imp.id(93900965249063864324)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(93900966493030864324)
,p_page_template_id=>wwv_flow_imp.id(93900965249063864324)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(93900966776726864324)
,p_page_template_id=>wwv_flow_imp.id(93900965249063864324)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(93900967083967864325)
,p_page_template_id=>wwv_flow_imp.id(93900965249063864324)
,p_name=>'Right Column'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(93900967361692864325)
,p_page_template_id=>wwv_flow_imp.id(93900965249063864324)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(93900967653788864325)
,p_page_template_id=>wwv_flow_imp.id(93900965249063864324)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(93900967958359864325)
,p_page_template_id=>wwv_flow_imp.id(93900965249063864324)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(93900968290491864325)
,p_page_template_id=>wwv_flow_imp.id(93900965249063864324)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(93900968603223864325)
,p_page_template_id=>wwv_flow_imp.id(93900965249063864324)
