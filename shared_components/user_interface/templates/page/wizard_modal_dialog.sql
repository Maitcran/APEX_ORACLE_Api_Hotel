...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(93900972355958864327)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(93900972671972864327)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(93900973008002864327)
,p_page_template_id=>wwv_flow_imp.id(93900972355958864327)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(93900973244942864327)
,p_page_template_id=>wwv_flow_imp.id(93900972355958864327)
