...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(93900973835431864327)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(93900974219250864327)
,p_plug_template_id=>wwv_flow_imp.id(93900973835431864327)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(93900974426656864328)
,p_plug_template_id=>wwv_flow_imp.id(93900973835431864327)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(93900974812234864328)
,p_plug_template_id=>wwv_flow_imp.id(93900973835431864327)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(93900975076553864328)
,p_plug_template_id=>wwv_flow_imp.id(93900973835431864327)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(93900975392168864328)
,p_plug_template_id=>wwv_flow_imp.id(93900973835431864327)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(93900975668171864328)
,p_plug_template_id=>wwv_flow_imp.id(93900973835431864327)
,p_name=>'Sub Regions'
