...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(93900979043109864329)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(93900979396985864329)
,p_plug_template_id=>wwv_flow_imp.id(93900979043109864329)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(93900979657244864330)
,p_plug_template_id=>wwv_flow_imp.id(93900979043109864329)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(93900980013610864330)
,p_plug_template_id=>wwv_flow_imp.id(93900979043109864329)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(93900980285453864330)
,p_plug_template_id=>wwv_flow_imp.id(93900979043109864329)
,p_name=>'Sub Regions'
