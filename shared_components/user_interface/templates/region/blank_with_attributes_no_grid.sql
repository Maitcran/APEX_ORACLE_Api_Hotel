...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(93900980436363864330)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(93900980761564864330)
,p_plug_template_id=>wwv_flow_imp.id(93900980436363864330)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(93900981031727864330)
,p_plug_template_id=>wwv_flow_imp.id(93900980436363864330)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(93900981345997864330)
,p_plug_template_id=>wwv_flow_imp.id(93900980436363864330)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(93900981709485864330)
,p_plug_template_id=>wwv_flow_imp.id(93900980436363864330)
,p_name=>'Sub Regions'
