...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(93900986198849864332)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(93900986471269864332)
,p_plug_template_id=>wwv_flow_imp.id(93900986198849864332)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(93900986774791864332)
,p_plug_template_id=>wwv_flow_imp.id(93900986198849864332)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(93900987061458864332)
,p_plug_template_id=>wwv_flow_imp.id(93900986198849864332)
,p_name=>'Sub Regions'
