...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(93900997941061864337)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(93900998231182864337)
,p_plug_template_id=>wwv_flow_imp.id(93900997941061864337)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(93900998534696864337)
,p_plug_template_id=>wwv_flow_imp.id(93900997941061864337)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(93900998836680864337)
,p_plug_template_id=>wwv_flow_imp.id(93900997941061864337)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(93900999171442864337)
,p_plug_template_id=>wwv_flow_imp.id(93900997941061864337)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(93900999497660864337)
,p_plug_template_id=>wwv_flow_imp.id(93900997941061864337)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(93900999818945864337)
,p_plug_template_id=>wwv_flow_imp.id(93900997941061864337)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(93901000119665864337)
,p_plug_template_id=>wwv_flow_imp.id(93900997941061864337)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(93901000411828864338)
,p_plug_template_id=>wwv_flow_imp.id(93900997941061864337)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(93901000683711864338)
,p_plug_template_id=>wwv_flow_imp.id(93900997941061864337)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(93901000961197864338)
,p_plug_template_id=>wwv_flow_imp.id(93900997941061864337)
,p_name=>'Sub Regions'
