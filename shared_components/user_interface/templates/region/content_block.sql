...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(93901007815299864340)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(93901008084929864341)
,p_plug_template_id=>wwv_flow_imp.id(93901007815299864340)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(93901008378053864341)
,p_plug_template_id=>wwv_flow_imp.id(93901007815299864340)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(93901008707731864341)
,p_plug_template_id=>wwv_flow_imp.id(93901007815299864340)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(93901008982829864341)
,p_plug_template_id=>wwv_flow_imp.id(93901007815299864340)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(93901009311394864341)
,p_plug_template_id=>wwv_flow_imp.id(93901007815299864340)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(93901009608714864341)
,p_plug_template_id=>wwv_flow_imp.id(93901007815299864340)
,p_name=>'Sub Regions'
