...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(93901012361678864342)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(93901012644282864343)
,p_plug_template_id=>wwv_flow_imp.id(93901012361678864342)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(93901012965750864343)
,p_plug_template_id=>wwv_flow_imp.id(93901012361678864342)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(93901013305621864343)
,p_plug_template_id=>wwv_flow_imp.id(93901012361678864342)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(93901013561280864343)
,p_plug_template_id=>wwv_flow_imp.id(93901012361678864342)
,p_name=>'Sub Regions'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(93901013884316864343)
,p_plug_template_id=>wwv_flow_imp.id(93901012361678864342)
,p_name=>'Up'
,p_placeholder=>'UP'
,p_has_grid_support=>false
