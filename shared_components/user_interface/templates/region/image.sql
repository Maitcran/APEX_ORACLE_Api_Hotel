...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(93901015904757864344)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(93901016198037864344)
,p_plug_template_id=>wwv_flow_imp.id(93901015904757864344)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(93901016503884864344)
,p_plug_template_id=>wwv_flow_imp.id(93901015904757864344)
,p_name=>'Sub Regions'
