...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(93901021268241864346)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(93901021601099864346)
,p_plug_template_id=>wwv_flow_imp.id(93901021268241864346)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(93901021894582864346)
,p_plug_template_id=>wwv_flow_imp.id(93901021268241864346)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(93901022133643864346)
,p_plug_template_id=>wwv_flow_imp.id(93901021268241864346)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(93901022452402864346)
,p_plug_template_id=>wwv_flow_imp.id(93901021268241864346)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(93901022812474864346)
,p_plug_template_id=>wwv_flow_imp.id(93901021268241864346)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(93901023028024864346)
,p_plug_template_id=>wwv_flow_imp.id(93901021268241864346)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(93901023340204864347)
,p_plug_template_id=>wwv_flow_imp.id(93901021268241864346)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(93901023674624864347)
,p_plug_template_id=>wwv_flow_imp.id(93901021268241864346)
,p_name=>'Sub Regions'
