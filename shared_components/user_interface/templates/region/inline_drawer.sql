...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(93901025881007864347)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(93901026132446864348)
,p_plug_template_id=>wwv_flow_imp.id(93901025881007864347)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(93901026516376864348)
,p_plug_template_id=>wwv_flow_imp.id(93901025881007864347)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(93901026794098864348)
,p_plug_template_id=>wwv_flow_imp.id(93901025881007864347)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(93901027025846864348)
,p_plug_template_id=>wwv_flow_imp.id(93901025881007864347)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(93901027388648864348)
,p_plug_template_id=>wwv_flow_imp.id(93901025881007864347)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(93901027656737864348)
,p_plug_template_id=>wwv_flow_imp.id(93901025881007864347)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(93901027943355864348)
,p_plug_template_id=>wwv_flow_imp.id(93901025881007864347)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(93901028299188864348)
,p_plug_template_id=>wwv_flow_imp.id(93901025881007864347)
,p_name=>'Sub Regions'
