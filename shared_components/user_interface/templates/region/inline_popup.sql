...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(93901030514468864349)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(93901030772992864349)
,p_plug_template_id=>wwv_flow_imp.id(93901030514468864349)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(93901031032270864349)
,p_plug_template_id=>wwv_flow_imp.id(93901030514468864349)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(93901031370983864350)
,p_plug_template_id=>wwv_flow_imp.id(93901030514468864349)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(93901031648651864350)
,p_plug_template_id=>wwv_flow_imp.id(93901030514468864349)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(93901031987027864350)
,p_plug_template_id=>wwv_flow_imp.id(93901030514468864349)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(93901032239902864350)
,p_plug_template_id=>wwv_flow_imp.id(93901030514468864349)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(93901032537972864350)
,p_plug_template_id=>wwv_flow_imp.id(93901030514468864349)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(93901032878028864350)
,p_plug_template_id=>wwv_flow_imp.id(93901030514468864349)
,p_name=>'Sub Regions'
