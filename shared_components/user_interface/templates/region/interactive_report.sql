...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(93901035885925864351)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(93901036218492864352)
,p_plug_template_id=>wwv_flow_imp.id(93901035885925864351)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(93901036463300864352)
,p_plug_template_id=>wwv_flow_imp.id(93901035885925864351)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(93901036820495864352)
,p_plug_template_id=>wwv_flow_imp.id(93901035885925864351)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(93901037049383864352)
,p_plug_template_id=>wwv_flow_imp.id(93901035885925864351)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(93901037350420864352)
,p_plug_template_id=>wwv_flow_imp.id(93901035885925864351)
,p_name=>'Sub Regions'
