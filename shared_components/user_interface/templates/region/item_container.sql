...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(93901037992927864352)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(93901038311515864352)
,p_plug_template_id=>wwv_flow_imp.id(93901037992927864352)
,p_name=>'Item'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(93901038603013864353)
,p_plug_template_id=>wwv_flow_imp.id(93901037992927864352)
,p_name=>'Button End'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(93901038876873864353)
,p_plug_template_id=>wwv_flow_imp.id(93901037992927864352)
,p_name=>'Button Start'
