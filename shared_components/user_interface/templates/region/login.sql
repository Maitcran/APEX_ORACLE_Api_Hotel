...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(93901040431851864353)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(93901040808844864353)
,p_plug_template_id=>wwv_flow_imp.id(93901040431851864353)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(93901041105076864354)
,p_plug_template_id=>wwv_flow_imp.id(93901040431851864353)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(93901041420997864354)
,p_plug_template_id=>wwv_flow_imp.id(93901040431851864353)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(93901041635535864354)
,p_plug_template_id=>wwv_flow_imp.id(93901040431851864353)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(93901041953613864354)
,p_plug_template_id=>wwv_flow_imp.id(93901040431851864353)
,p_name=>'Sub Regions'
