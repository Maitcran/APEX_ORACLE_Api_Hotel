...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(93901042953670864354)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(93901043254263864354)
,p_plug_template_id=>wwv_flow_imp.id(93901042953670864354)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(93901043612589864355)
,p_plug_template_id=>wwv_flow_imp.id(93901042953670864354)
,p_name=>'Search Field'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(93901043920049864355)
,p_plug_template_id=>wwv_flow_imp.id(93901042953670864354)
,p_name=>'Sub Regions'
