...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(93901055433019864359)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(93901055754532864359)
,p_plug_template_id=>wwv_flow_imp.id(93901055433019864359)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(93901056059994864359)
,p_plug_template_id=>wwv_flow_imp.id(93901055433019864359)
,p_name=>'Tabs'
