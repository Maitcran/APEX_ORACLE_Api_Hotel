...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(93901058111985864360)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(93901058394558864360)
,p_plug_template_id=>wwv_flow_imp.id(93901058111985864360)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(93901058651364864360)
,p_plug_template_id=>wwv_flow_imp.id(93901058111985864360)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(93901058948147864360)
,p_plug_template_id=>wwv_flow_imp.id(93901058111985864360)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(93901059243564864361)
,p_plug_template_id=>wwv_flow_imp.id(93901058111985864360)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(93901059555744864361)
,p_plug_template_id=>wwv_flow_imp.id(93901058111985864360)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(93901059841092864361)
,p_plug_template_id=>wwv_flow_imp.id(93901058111985864360)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(93901060188457864361)
,p_plug_template_id=>wwv_flow_imp.id(93901058111985864360)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(93901060509325864361)
,p_plug_template_id=>wwv_flow_imp.id(93901058111985864360)
,p_name=>'Help'
,p_placeholder=>'HELP'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(93901060753444864361)
,p_plug_template_id=>wwv_flow_imp.id(93901058111985864360)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(93901061116185864361)
,p_plug_template_id=>wwv_flow_imp.id(93901058111985864360)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(93901061336489864361)
,p_plug_template_id=>wwv_flow_imp.id(93901058111985864360)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(93901061659371864362)
,p_plug_template_id=>wwv_flow_imp.id(93901058111985864360)
,p_name=>'Sub Regions'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(93901061955524864362)
,p_plug_template_id=>wwv_flow_imp.id(93901058111985864360)
,p_name=>'Up'
,p_placeholder=>'UP'
,p_has_grid_support=>false
