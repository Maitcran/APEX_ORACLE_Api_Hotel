...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(93901063138293864362)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(93901063512053864362)
,p_plug_template_id=>wwv_flow_imp.id(93901063138293864362)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(93901063824572864362)
,p_plug_template_id=>wwv_flow_imp.id(93901063138293864362)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(93901064108103864363)
,p_plug_template_id=>wwv_flow_imp.id(93901063138293864362)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(93901064348376864363)
,p_plug_template_id=>wwv_flow_imp.id(93901063138293864362)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(93901064721536864363)
,p_plug_template_id=>wwv_flow_imp.id(93901063138293864362)
